...
Report bugs at https://github.com/ciscoucs/ucsc_apis/issues.
...
or if you only want to run tests in a specific file (e.g. test_radius.py):

    nosetests -vs tests/admin/test_radius.py
...
The best way to send feedback is to file an issue at https://github.com/ciscoucs/ucsc_apis/issues.
